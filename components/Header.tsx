            ...
            <div className="relative group">
              <a href="#" className="text-gray-600 hover:text-primary transition-colors">
                {t('header.contact')}
                             ...
                             <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
                 {language === 'ja' 
